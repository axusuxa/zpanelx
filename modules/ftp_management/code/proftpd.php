...
if (!fs_director::CheckForEmptyValue(self::$create)) {
    ...
    $sql->execute();
    $sql = $ftp_db->prepare("INSERT INTO ftpuser (id, userid, passwd, homedir, shell, count, accessed, modified) VALUES (NULL, :username, :password, :homedir, '/sbin/nologin', 0, NOW(), NOW());");
    $sql->bindParam(':username', $username);
